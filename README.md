...
The `wifidump` capture interface allows you to perform remote Wi-Fi captures on a specific channel and channel width using a Linux device's Wi-Fi adapter.
